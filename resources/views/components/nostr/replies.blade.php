            ...
            <template x-for="(reply, index) in eventsReplies[event.id]" :key="reply.id">
                <li>
                    <div class="relative pb-8">
                        <span x-show="index + 1 !== eventsReplies[event.id].length || eventsReplies[reply.id]"
                            ...
                            <div class="min-w-0 flex-1">
                                <template x-if="authorMetaData[reply.pubkey]">
                                    <div>
                                        ...
                                        <p class="mt-0.5 text-sm text-gray-300 italic" x-text="formatDate(reply.created_at)"></p>
                                    </div>
                                </template>
                                ...
                                <li>
                                    <div class="relative pb-8">
                                        <span
                                                ...
                                                class="absolute left-5 top-5 rotate-180 -ml-px h-full w-0.5 bg-amber-500" aria-hidden="true"></span>
                                        <div class="relative flex items-start space-x-3">
                                            <div class="relative">
                                            ...
                                            <div class="min-w-0 flex-1">
                                                <template x-if="authorMetaData[r.pubkey]">
                                                    <div>
                                                        ...
                                                        <p class="mt-0.5 text-sm text-gray-300 italic" x-text="formatDate(r.created_at)"></p>
                                                    </div>
                                                </template>
                                                <div class="mt-2 text-sm text-gray-200">
