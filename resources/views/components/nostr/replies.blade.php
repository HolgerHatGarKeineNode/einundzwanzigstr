                                                ...
                                                <template x-for="(r2, i2) in eventsReplies[r.id]">
                                                    <li>
                                                        <div class="relative pb-2">
                                                            ...
                                                            <div class="relative flex items-start space-x-3">
                                                                <div class="relative">
                                                                    <template x-if="authorMetaData[r2.pubkey]">
                                                                        <img class="flex h-10 w-10 items-center justify-center rounded-full bg-gray-400 ring-8 ring-amber-500"
                                                                             :src="authorMetaData[r2.pubkey].image"
                                                                             :alt="authorMetaData[r2.pubkey].display_name && authorMetaData[r2.pubkey].display_name[0]"
                                                                        >
                                                                    </template>
                                                                    <span class="absolute -bottom-0.5 -right-1 rounded-tl bg-transparent px-0.5 py-px">
                                                        ...
                                                        <template x-if="eventsReplies[r2.id]">
                                                            <ul role="list" class="ml-6 mb-3">
                                                                {{-- LEVEL4 --}}
                                                                    ...
                                                                    <li>
                                                                        <div class="relative pb-2">
                                                                            ...
                                                                            <div class="relative flex items-start space-x-3">
                                                                                <div class="relative">
                                                                                    <template
                                                                                            x-if="authorMetaData[r3.pubkey]">
                                                                                        <img class="flex h-10 w-10 items-center justify-center rounded-full bg-gray-400 ring-8 ring-amber-500"
                                                                                             :src="authorMetaData[r3.pubkey].image"
                                                                                             :alt="authorMetaData[r3.pubkey].display_name && authorMetaData[r3.pubkey].display_name[0]"
                                                                                        >
                                                                                    </template>
                                                                                    <span class="absolute -bottom-0.5 -right-1 rounded-tl bg-transparent px-0.5 py-px">
                                                                                      <svg class="h-5 w-5 text-purple-500"
