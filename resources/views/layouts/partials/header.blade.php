@props([
    'withHasNewEvents' => true,
    'withCreateNoteModal' => true,
])

<div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-6 border-b border-white/5 bg-[#1b1b1b] px-4 shadow-sm sm:px-6 lg:px-8">
